...
try:
    ...
    print "ImportError: Couldn't find fabsettings.py (have you copied from example_fabsettings.py?), it either does not exist or giving import problems (missing settings)"
    sys.exit(1)
